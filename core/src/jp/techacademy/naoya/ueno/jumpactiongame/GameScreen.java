package jp.techacademy.naoya.ueno.jumpactiongame;
...
public class GameScreen extends ScreenAdapter {
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.naoya.ueno.jumpactiongame"); // ←追加する
    ...
    private void createStage() {
        ...
        while (y < WORLD_HEIGHT - 5) {
            ...
            if (mRandom.nextFloat() > 0.9f) {
                Enemy enemy = new Enemy(enemyTexture, 0, 0, 96, 96);
